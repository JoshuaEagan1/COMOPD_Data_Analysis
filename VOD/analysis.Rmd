...
The primary mode of analysis in this paper, Veil of Darkness, only examines a subset of the data on traffic stops (see the Methodology section for more information.) See the summary statistics below for the subset included in the Veil of Darkness analysis and the subset that won't be included. 
